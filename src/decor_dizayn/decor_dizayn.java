...
/**
 * Created by SretenskyVD on 01.09.2020.
 */
public class decor_dizayn {
    public static void main(String[] args) throws IOException {
        System.setProperty("https.protocols", "TLSv1,TLSv1.1,TLSv1.2");
        System.setProperty("javax.net.ssl.trustStore", "S:/ProjectJava/Kwork/src/decor_dizayn/decor-dizayn.ru_cer.cer.jks");
        String Tovar = "Скрытое освещение";
        String Manual_category =Tovar;
//        String Suff ="o3221e11о1-19";
//        String Artikul_text="Код";
//        String Manual_Proizvoditel = "Цветомания";

        String Path = "https://decor-dizayn.ru/catalog/belaya-lepnina/skrytoe-osveshchenie/";
//keytool -import -v -file S:/ProjectJava/Kwork/src/decor_dizayn/decor-dizayn.ru.cer -keystore S:/ProjectJava/Kwork/src/decor_dizayn/decor-dizayn.ru.cer.cer.jks -storepass drowssap
...
//            Elements links3 = doc1.getElementsByClass("e-new-catalogue-item e-new-catalogue-h");
            Elements links3 = doc1.getElementsByClass("sec_card-wrapper").select("a");
...
//                    System.out.println(sku);
                    ...
                    String sku =   doc4.getElementsByClass("item_article").text();
                    System.out.println(sku);
...
//                    System.out.println(Proizvoditel);
                    ...
                    String Description  = doc4.getElementsByClass("item_text").html();
                    System.out.println(Description);

                    String Description2  = doc4.getElementsByClass("desc-area active-area").html();
...
///////////////////////////////////
                    try {
                        Elements features = doc4.getElementsByClass("product-options").select("li");
                        ...
                        for (Element featureses : features) {
                            ...
                            String ATTRIBUTE = doc4.getElementsByClass("option-title").get(z11).text();
                            String ATTRIBUTE2 =doc4.getElementsByClass("option-body").get(z11).text();
...
/////////////////////////////////
                    ...
                    Elements table = doc4.getElementsByClass("item_info-item");
                    Iterator<Element> ite = table.select("div").iterator();
                    Elements row2 = table.select("span");
                    int y2 = 10;
                    for (Element rows : row2) {
                        String Har = ite.next().text();
                        System.out.print(Har);
...
/////////////////////////////////
//                    Elements table2 = doc4.getElementsByClass("item_info-item");
//                    Iterator<Element> ite2 = table2.select("div").iterator();
//                    Elements row22 = table2.select("div");
//                    int y22 = 11;
//                    for (Element rows : row22) {
//                        String Har2 = ite2.next().text();
//                        System.out.print(Har2);
//                        Cell cell1000w = row.createCell(y2);
//                        cell1000w.setCellValue(Har2);
//                        y22=y22+2;
//                    }
//
//
...
/////////////////////////////////////////////////////////
                    try {
                        Elements pictures = doc4.getElementsByClass("item_slider").select("img");
                        ...
                        for (Element picture : pictures) {
                            ...
                            String Foto = "https://decor-dizayn.ru"+ pictures.get(z).attr("src");
...
//                    try {
//                        Elements pictures = doc4.getElementsByClass("product-item-detail-slider-controls-image item_slider-min active");
//
//                        int z = 0;
//                        //                      int y3 = 6;
//                        int y3 = 37;
...
//                    cell2279rand.setCellValue(ID_random);
                    ...
                    Cell cell227AutoCategory = row.createCell(5);
