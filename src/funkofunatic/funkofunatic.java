...
//        String  Path2 = Path;
            ...
            Elements links3 = doc1.getElementsByClass("nxowoo-box");
            int yyy = 0;
...
//
            String MainPrice = doc1.getElementsByClass("woocommerce-Price-amount amount").get(yyy).text();
...
//                    String MainPrice = doc4.getElementsByClass("woocommerce-Price-amount amount").text();
//                    System.out.println(MainPrice);
...
//                     String Description  = doc4.getElementsByTag("div").select("[itemprop=description]").select("p").text();
                    String Description  = doc4.getElementsByClass("woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content wc-tab").text();
