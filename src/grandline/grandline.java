...
/**
 * Created by SretenskyVD on 27.11.2019.
 */
public class grandline {
    public static void main(String[] args) throws IOException {
        System.setProperty("javax.net.ssl.trustStore", "S:/ProjectJava/Kwork/src/grandline/grandline_ru.crt.jks");
        String Tovar = "Прочее_внешняя отделка и вентиляция";
...
//        String Path = "https://unikma.ru/catalog/zabory_iz_svarnykh_paneley/?PAGEN_2=";
        String Path = "https://www.grandline.ru/katalog/fasad/profilirovannye-membrany-planter/";
//keytool -import -v -file S:/ProjectJava/Kwork/src/grandline/grandline_ru.crt -keystore S:/ProjectJava/Kwork/src/grandline/grandline_ru.crt.jks -storepass drowssap
...
//        String  Path2 = Path;
            ...
            Elements links3 = doc1.getElementsByClass("product__title");
            int yyy = 0;
...
//);
                    ...
                    String MainPrice = doc4.getElementsByClass("price__num").text();
                    System.out.println(MainPrice);
...
//                    System.out.println(SKU);
                    ...
                    String SKU  = doc4.getElementsByClass("p-view__code-1c").select("[itemprop=productID]").attr("content");
                    System.out.println(SKU);

                    //.select("[name=id]").attr("value");

//                     String Description  = doc4.getElementsByTag("div").select("[itemprop=description]").select("p").text();
                    String Description  = doc4.getElementsByTag("div").select("[itemprop=description]").text();
//                    String Description2 = Description.toString();
                    ...
                    String breadcrumbs  = doc4.getElementsByClass("breadcrumbs").select("li").text();
                    System.out.println(breadcrumbs);

                    String breadcrumbs_last  = doc4.getElementsByClass("breadcrumbs").select("li").last().text();
                    System.out.println(breadcrumbs_last);

                    String MainFoto = doc4.getElementsByClass("p-view__photo").select("img").attr("src");
...
//
                    ...
                    cell22411.setCellValue(breadcrumbs);
