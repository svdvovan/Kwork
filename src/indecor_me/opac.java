...
/**
 * Created by SretenskyVD on 04.02.2019.
 */
public class opac {
    public static void main(String[] args) throws IOException {

        String Tovar = "Дверное обрамление";
        String Manual_category ="Дверное обрамление";
        String Manual_Proizvoditel = "Orac Decor";

        String Path = "http://orac.ru/lepnina/dvernoe-obramlenie/";
...
//            String  Path2 = Path+ "?p=" + Page;
            ...
            Elements links3 = doc1.getElementsByClass("caption");
            int yyy = 0;
