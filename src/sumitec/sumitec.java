...
/**
 * Created by SretenskyVD on 02.12.2020.
 */
public class sumitec {
    public static void main(String[] args) throws IOException {
        System.setProperty("https.protocols", "TLSv1,TLSv1.1,TLSv1.2");
        System.setProperty("javax.net.ssl.trustStore", "S:/ProjectJava/Kwork/src/sumitec/sumitec.cer.jks");
        String Tovar = "Харвестерные агрегаты";
        String Manual_category =Tovar;
//        String Suff ="o3221e11о1-19";
//        String Artikul_text="Код";
//        String Manual_Proizvoditel = "Цветомания";

        String Path = "https://sumitec.ru/catalog/komatsu-forest/kharvesternye-agregaty/";
//keytool -import -v -file S:/ProjectJava/Kwork/src/sumitec/sumitec.cer -keystore S:/ProjectJava/Kwork/src/sumitec/sumitec.cer.jks -storepass drowssap
...
//            String  Path2 = Path;
            ...
            Elements links3 = doc1.getElementsByClass("d-flex align-items-center mb-3");
...
//);
                    ...
                    String AutoCategory = doc4.getElementsByClass("breadcrumb__item breadcrumb__item_active").text();
...
//                    System.out.println(Proizvoditel);
                    ...
                    String Description  = doc4.getElementsByClass("tab-pane fade show active").html();
...
//
//
//                    Elements table = doc4.getElementsByClass("tbody").select("td");
...
///////////////////////////////////
                    String MainFoto = doc4.getElementsByClass("bloc-slick-img bloc-slick-img_big js-mp-image").attr("href");
                    String Foto1="https://sumitec.ru"+MainFoto;
...
//                    }
                    ...
                    ////////////////////////////////////////////////////////////////////////////----------------1
                    try {
                        Elements features = doc4.getElementsByClass("row");
                        ...
                        for (Element featureses : features) {
                            ...
                            String ATTRIBUTE = doc4.getElementsByClass("col-6 p-3 border-b-grey").get(z11).text();
                            String ATTRIBUTE2 =doc4.getElementsByClass("col-6 col-lg-4 p-3 border-b-grey").get(z11).text();
...
//                        Elements features = doc4.getElementsByClass("row").get(0).select("div");
//
//                        int z11 = 0;
//                        int y311 = 28;
//                        int y411 =29;
...
//                        for (Element featureses : features) {
//
//                            String ATTRIBUTE = doc4.getElementsByClass("col-md-4").get(z11).text();
//                            String ATTRIBUTE2 =doc4.getElementsByClass("col-md-8").get(z11).text();
//                            Cell cell5555 = row.createCell(y311);
//                            Cell cell6666 = row.createCell(y411);
//                            System.out.println(ATTRIBUTE + " " +ATTRIBUTE2);
//                            cell5555.setCellValue(ATTRIBUTE);
