...
/**
 * Created by SretenskyVD on 12.11.2020.
 */
public class doosan_com {
    public static void main(String[] args) throws IOException {
        System.setProperty("https.protocols", "TLSv1,TLSv1.1,TLSv1.2");
        System.setProperty("javax.net.ssl.trustStore", "S:/ProjectJava/Kwork/src/doosan_com/doosan_com.cer.jks");
        String Tovar = "Судовые двигатели";
        String Manual_category =Tovar;
//        String Suff ="o3221e11о1-19";
//        String Artikul_text="Код";
//        String Manual_Proizvoditel = "Цветомания";

        String Path = "https://doosan.com.ru/products/sudovye-dvigateli";
//keytool -import -v -file S:/ProjectJava/Kwork/src/doosan_com/doosan_com.cer -keystore S:/ProjectJava/Kwork/src/doosan_com/doosan_com.cer.jks -storepass drowssap
