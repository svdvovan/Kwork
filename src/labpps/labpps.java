...
//        String Path = "https://unikma.ru/catalog/zabory_iz_svarnykh_paneley/?PAGEN_2=";
        String Path = "http://labpps.ru/catalog/ik-osvetiteli.html";
...
//        for (int count = 1; count <= LastPage; count++) {
 //           String  Path2 = Path+"?PAGEN_1="+ Page;
       String  Path2 = Path;
            ...
            Elements links3 = doc1.getElementsByClass("uk-panel uk-panel-header uk-animation-fade uk-margin-bottom product-teaser");
            int yyy = 0;
...
//
            String MainPrice = doc1.getElementsByClass("jshop_price").get(yyy).text();
...
//                    System.out.println(SKU);
                    ...
                    String Description  = doc4.getElementsByClass("product-page-description").select("p").html();
                    System.out.println(Description);
//                    String Description  = doc4.getElementsByClass("product-page-description").html();
//                    System.out.println(Description);

                    String Description_text  = doc4.getElementsByClass("product-page-short-description").html();
                    System.out.println(Description_text);

//                    String breadcrumbs  = doc4.getElementsByClass("breadcrumbs").select("a").text();
...
//
//                    Cell cell22411 = row.createCell(4);
...
//////////////////////////////////////////
                    ...
                    Elements table = doc4.getElementsByClass("uk-table uk-table-hover uk-table-striped");
...
//                    Elements table1 = doc4.getElementsByClass("description-table-small");
...
//                    }
                    ...
                    try {
                        Elements pictures = doc4.getElementsByClass("uk-slideshow").select("a");
