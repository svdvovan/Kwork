...
/**
 * Created by SretenskyVD on 14.04.2019.
 */
public class mandarinkin {
    public static void main(String[] args) throws IOException {
        System.setProperty("https.protocols", "TLSv1,TLSv1.1,TLSv1.2");
        System.setProperty("javax.net.ssl.trustStore", "S:/ProjectJava/Kwork/src/mandarinkin/cert/mandarinkinru.crt.jks");
        String Tovar = "Бакалей_напитки";
        String Manual_category =Tovar;
//        String Manual_Proizvoditel = "Цветомания";

        String Path = "https://mandarinkin.ru/product-category/bakaleya/page/";
//keytool -import -v -file S:/ProjectJava/Kwork/src/mandarinkin/cert/mandarinkinru.crt -keystore S:/ProjectJava/Kwork/src/mandarinkin/cert/mandarinkinru.crt.jks -storepass drowssap
...
//            String  Path2 = Path;
            ...
            Elements links3 = doc1.getElementsByClass("noo-product-title");
            int yyy = 0;
            int yyyy =1;
...
//                System.out.println(MainPrice);
                String MainPrice = doc1.getElementsByClass("woocommerce-Price-amount amount").get(yyyy).text();
                System.out.println(MainPrice);

                System.out.println();
                String addressUrl3 = (links3.get(yyy).select("a[href]").get(3).attr("abs:href"));
...
//                    System.out.println(NamePrduct);
                    ...
                    String smallCategory =   doc4.getElementsByClass("posted_in").select("a").get(1).text();
...
//
                    ...
                    cell2242.setCellValue(Description_main);
