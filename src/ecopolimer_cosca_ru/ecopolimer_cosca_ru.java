...
/**
 * Created by SretenskyVD on 31.08.2020.
 */
public class ecopolimer_cosca_ru {
    public static void main(String[] args) throws IOException {
        System.setProperty("https.protocols", "TLSv1,TLSv1.1,TLSv1.2");
        System.setProperty("javax.net.ssl.trustStore", "S:/ProjectJava/Kwork/src/ecopolimer_cosca_ru/ecopolimer.cosca.ru.cer.jks");
        String Tovar = "Клей";
...
//        String Manual_Proizvoditel = "Цветомания";
        ...
        String Path = "https://ecopolimer.cosca.ru/soputstvuyushchiye-tovary";
//keytool -import -v -file S:/ProjectJava/Kwork/src/ecopolimer_cosca_ru/ecopolimer.cosca.ru.cer -keystore S:/ProjectJava/Kwork/src/ecopolimer_cosca_ru/ecopolimer.cosca.ru.cer.jks -storepass drowssap
...
//            Elements links3 = doc1.getElementsByClass("e-new-catalogue-item e-new-catalogue-h");
            Elements links3 = doc1.getElementsByClass("product-name");
...
//                    System.out.println(Proizvoditel);
                    ...
                    String Description  = doc4.getElementsByClass("product-shop-description-wr").html();
...
/////////////////////////////////////////////////////////
                    try {
                        Elements pictures = doc4.getElementsByClass("product-image").select("a");
                        ...
                        for (Element picture : pictures) {
                            ...
                            String Foto = "https://ecopolimer.cosca.ru"+ pictures.get(z).attr("href");
