...
/**
 * Created by SretenskyVD on 16.10.2018.
 */
public class protectorshin_1 {
    public static void main(String[] args) throws IOException {
        ...
        for (int count = 1; count <= LastPage; count++) {
            ...
            for (Element link3 : links3) {
                ...
                String KOD_product1 = doc4.getElementsByClass("htabs").next().html();  //всегда ли код первым?
...
//
//                String Proizvoditel55 = doc4.getElementsByClass("tab-content").text();
//                System.out.println(Proizvoditel55);
