...
/**
 * Created by SretenskyVD on 26.08.2020.
 */
public class vaskyndim {
    public static void main(String[] args) throws IOException {
        System.setProperty("https.protocols", "TLSv1,TLSv1.1,TLSv1.2");
        System.setProperty("javax.net.ssl.trustStore", "S:/ProjectJava/Kwork/src/vaskyndim/vaskyndim.cer.jks");
        String Tovar = "Зимові комбінезони";
        String Manual_category =Tovar;
        String Suff ="o3221e11о1-19";
        String Artikul_text="Код";
//        String Manual_Proizvoditel = "Цветомания";

        String Path = "https://vaskyndim.com.ua/g82937556-zimovi-kombinezoni";
//keytool -import -v -file S:/ProjectJava/Kwork/src/vaskyndim/vaskyndim.cer -keystore S:/ProjectJava/Kwork/src/vaskyndim/vaskyndim.cer.jks -storepass drowssap
...
//            Elements links3 = doc1.getElementsByClass("e-new-catalogue-item e-new-catalogue-h");
            Elements links3 = doc1.getElementsByClass("cs-goods-title");
            int yyy = 0;
            int yyyy =1;
...
//                System.out.println(MainPrice);
//                String MainPrice = doc1.getElementsByClass("cs-goods-price__value cs-goods-price__value_type_old cs-goods-price__value_type_product-list").get(yyy).text();
//                System.out.println(MainPrice);
...
//                    System.out.println(Proizvoditel);
                    ...
                    String Description  = doc4.getElementsByClass("b-user-content").html();
...
/////////////////////////////////
                    ...
                    Elements table = doc4.getElementsByClass("b-product-info");
...
///////////////////////////////////
                    String MainFoto = doc4.getElementsByClass("cs-sticky-panel__body").attr("href");
...
/////////////////////////////////////////////////////////
                    try {
                        Elements pictures = doc4.getElementsByClass("cs-sticky-panel__image");
...
/////////////////////////////////////////////////////////// обработка
                    ...
                    cell227AutoCategory.setCellValue(AutoCategory);
