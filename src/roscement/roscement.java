...
//        String  Path2 = Path+ Page;
        ...
        Elements links3 = doc1.getElementsByClass("span4 ty-product-list__image");
        int yyy = 0;
...
//);
                ...
                String MainPrice = doc4.getElementsByClass("ty-price-num").first().text();
                System.out.println(MainPrice);
...
//                    System.out.println(Proizvoditel);
                ...
                String SKU  = doc4.getElementsByClass("ty-control-group__item").first().text();
                System.out.println(SKU);

                String Description  = doc4.getElementsByClass("ty-wysiwyg-content content-description").html();
...
//                }
                ...
                try {
                    Elements chars = doc4.getElementsByClass("ty-product-feature");
                    ...
                    for (Element charses : chars) {
                        ...
                        String ATTRIBUTE2 = chars.get(z).select("div").last().text();
...
///////////////////////////////////
                String MainFoto = doc4.getElementsByClass("cm-image-previewer cm-previewer ty-previewer").attr("href");
