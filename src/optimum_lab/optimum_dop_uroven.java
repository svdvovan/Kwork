...
//         String Path = "http://www.optimum-lab.ru/category/himreaktivy/";
        ...
        for (Element link1 : links1) {
            ...
            for (Element link2 : links2) {
                ...
                Elements links3 = doc3.getElementsByClass("subcat theme-border-color-hover theme-shadow-color");
                ...
                for (Element link3 : links3) {
                    ...
                    for (int count = 1; count <= LastPage; count++) {
                        String  Path2 = addressUrl3+ "?page=" + Page;

                        Document doc6 = Jsoup.connect(Path2).get();

                    Elements links4 = doc6.getElementsByClass("sproduct-info");
